...
function DecryptedText(props) {
  ...
  useEffect(() => {
    ...
    if (isHovering) {
      ...
      setDisplayText(initialDisplay || text);
  ...
  }, [isHovering, text, speed, maxIterations, sequential, revealDirection, characters, useOriginalCharsOnly, initialDisplay]);
  useEffect(() => {
